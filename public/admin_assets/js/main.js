...
function statusUpdate(id) {
    ...
    var paymenttStatus=jQuery('#payment_Status').val()
    // alert(paymenttStatus);
    if (check==true){
        window.location.href='/admin/updateStatus/'+paymenttStatus+'/'+id;
    }
}
...
function OrderStatusUpdate(id) {
    ...
    // alert(orderStatus);
    if (check==true){
        window.location.href='/admin/update_order_status/'+orderStatus+'/'+id;
    }
}
