...
jQuery('#frmPlaceOrder').submit(function(e){
    jQuery('#orderPlaceMsg').html("Please Wait......");
    e.preventDefault();
    jQuery.ajax({
        url:'/place_order',
        ...
        success:function(result){
            ...
            jQuery('#orderPlaceMsg').html(result.msg);

        }
    });
});

jQuery('#frmReviewProduct').submit(function(e){
    jQuery('#review_msg').html("");
    e.preventDefault();
    jQuery.ajax({
        url:'/review_product',
        data:jQuery('#frmReviewProduct').serialize(),
        type:'post',
        success:function(result){
            console.log(result);
            if (result.status=='success'){
                setInterval(function () {
                    window.location.href=window.location.href
                    jQuery('#frmReviewProduct')[0].reset();
