...
Route::post('removeCouponCode',[FrontController::class,'removeCouponCode']);
...
Route::post('review_product',[FrontController::class,'review_product']);
...
Route::group(['middleware'=>'admin_auth'],function(){
    ...
    Route::get('admin/delete_review/{id}',[ReviewController::class,'delete']);
    Route::get('admin/updateReviewStatus/{status}/{id}',[ReviewController::class,'status']);
    ...
    Route::get('admin/updateStatus/{status}/{id}',[orderController::class,'updateStatus']);
